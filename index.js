...
const usersWithBalanceBiggestThenTwoThousandPhones = usersWithBalanceBiggestThenTwoThousands
  .map(function(user) {
    return user.phone;
  })
...
const sumOfUsersWithBalanceBiggestThenTwoThousandsBalances = usersWithBalanceBiggestThenTwoThousands
  ...
  .reduce(function(prevValue, currentValue) {
    return Math.round((prevValue + currentValue) * 100) / 100;
  })

  
  
console.log(usersWithBalanceBiggestThenTwoThousandPhones);
console.log(sumOfUsersWithBalanceBiggestThenTwoThousandsBalances);
